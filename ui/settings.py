    ...
    def _build_profile_card(self, parent):
        ...
        for label, key, default in [
            ...
            ctk.CTkLabel(
                ...
                text_color=THEME["text_main"], anchor="w", width=160
            ).pack(side="left")
            entry = ctk.CTkEntry(
        ...
        self.profile_status = ctk.CTkLabel(
            card, text="", font=("Arial", 12), text_color=THEME["success"]
        )
        ...
        ctk.CTkButton(
            ...
            command=lambda: self.profile_status.configure(
                text="Profile saved.", text_color=THEME["success"]
            )
    ...
    def _build_fees_card(self, parent):
        ...
        ctk.CTkButton(
            ...
            command=lambda: self.fees_status.configure(
                text="Fees saved.", text_color=THEME["success"]
            )
        ).pack(pady=16, padx=24, fill="x")
    ...
    def _create_backup(self):
        ...
        try:
            ...
            self.backup_status.configure(
                text="Backup saved as " + dst, text_color=THEME["success"]
            )
        except Exception as e:
            self.backup_status.configure(
                text="Backup failed: " + str(e), text_color=THEME["danger"]
            )